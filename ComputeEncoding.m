function  [AllCoef] = ComputeEncoding(sua_id, SpikesCell, line_timesS)
...
for trial = 1:TotalTrials
 ...
 EndSlidingWindow = line_timesS(trial,9) + Slidingwindows25ms(ventana);
    ...
    StimDischarge(trial,1) = getDischargeStimWindow(SpikesCell{trial}, line_timesS(trial,:),StrSlidingWindow,EndSlidingWindow);
    Distance(trial,1) = stim;
    
    DischargeperMag(repetition,r) = getDischargeStimWindow(SpikesCell{trial}, line_timesS(trial,:),StrSlidingWindow,EndSlidingWindow);
